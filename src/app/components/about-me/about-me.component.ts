...
changeLang = inject(LanguageService);
  ...
  contentText = [
    ...
    {
      eng: 'Hi, my name is Christian and I am a front-end developer. I am from a small village named Bornich in southwest Germany. Developing programs, websites and other projects has been my passion for over 25 years. Through professional training as a front-end developer, I have acquired the necessary skills to program web presentations and complex business and gaming applications.',
    ...
    {
      eng: "In addition to the skills I have learned, I also like to try out other areas of IT development. I am very interested in expanding my knowledge and experience. I am currently training in the backend area to work as a full-stack developer in the future.",
